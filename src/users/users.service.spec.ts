...
describe('UsersService', () => {
  ...
  beforeEach(() => {
    ...
    service = new UsersService(
      ...
      { sendEmailVerification: jest.fn() } as never,
  ...
  describe('verifyOtpToken (OTP de login)', () => {
    const hash = bcrypt.hashSync('123456', 4); // vrai hash, tours réduits pour la vitesse
    ...
    it('Unauthorized si le code ne correspond pas au hash', async () => {
      ...
      await expect(
        service.verifyOtpToken('u1', '000000', 'EMAIL' as never),
